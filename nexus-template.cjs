...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Sonderpädagogische Weiterbildungsverwaltung";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Lehrkraft";
process.env.TABLE_NAME = process.env.TABLE_NAME || "lehrkraft_records";
'use strict';
